    ...
    var body: some View {
        ScrollView {
            ...
            VStack(alignment: .leading){
                Text("Здравствуйте!").font(.system(size: 32, weight: .heavy)).foregroundColor(Color.purple)
                Text("Зарегистрируйтесь, чтобы продолжить").font(.system(size: 16, weight: .medium)).foregroundColor(Color.purple)
            ...
            Button(action: signUp){
                    Text("Зарегистрироваться").font(.title).modifier(ButtonModifiers())
            }.accentColor(/*@START_MENU_TOKEN@*/Color.pink/*@END_MENU_TOKEN@*/).cornerRadius(/*@START_MENU_TOKEN@*/14.0/*@END_MENU_TOKEN@*/).alert(isPresented: $showingAlert) {
